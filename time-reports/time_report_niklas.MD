...
| 2020-1-10   | 1       | Fixed the communication problem between servers.|
| 2020-1-10   | 3       | Finished solution for tracking if users are online and started working on fixing so clients don't call the simulator server.|
| Total time  | 40.5    | ...|
